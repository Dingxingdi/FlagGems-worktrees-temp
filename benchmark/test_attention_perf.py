...
# Multi-Head Attention MHA Benchmark
@pytest.mark.multi_head_attention_mha
def test_perf_multi_head_attention_mha():
    """Benchmark for multi_head_attention_mha"""

    def mha_input_fn(shape, dtype, device):
    ...
    bench = AttentionBenchmark(
        op_name="multi_head_attention_mha",
        input_fn=mha_input_fn,
        torch_op=torch_mha,
        dtypes=[
            torch.float16,
            torch.bfloat16,
    ...
    bench.set_gems(flag_gems.multi_head_attention_mha)
    bench.run()
