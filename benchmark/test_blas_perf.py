...
class MatmulBiasActivationBenchmark(BlasBenchmark):
    """
...
def test_matmul_bias_activation_benchmark():
    def matmul_bias_activation_torch_op(input, weight, bias):
    ...
    bench = MatmulBiasActivationBenchmark(
        ...
        torch_op=matmul_bias_activation_torch_op,
        dtypes=FLOAT_DTYPES,
    )
    bench.run()
