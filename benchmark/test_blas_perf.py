...
class VecdotBenchmark(BlasBenchmark):
    """
    benchmark for linalg.vecdot
    """
    ...
    def init_user_config(self):
        # Skip the parent's init_user_config which overrides shapes
        # Only set dtypes and metrics from config
