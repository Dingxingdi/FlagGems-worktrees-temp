...
def if_input_fn(shape, cur_dtype, device):
    condition = generate_tensor_input(shape, torch.bool, device)
    then_val = generate_tensor_input(shape, cur_dtype, device)
    else_val = generate_tensor_input(shape, cur_dtype, device)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            "If", flag_gems.If, if_input_fn, FLOAT_DTYPES, marks=pytest.mark.If
        ),
        pytest.param(
            "threshold",
