...
def test_perf_native_batch_norm_legit_functional():
    bench = NormBenchmark(
        input_fn=native_batch_norm_legit_functional_input_fn,
        op_name="_native_batch_norm_legit_functional",
        torch_op=torch.ops.aten._native_batch_norm_legit_functional,
        dtypes=FLOAT_DTYPES,
    )
    bench.set_gems(torch.ops.aten._native_batch_norm_legit_functional)
    bench.run()
