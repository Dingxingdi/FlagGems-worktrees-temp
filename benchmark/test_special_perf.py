...
SMOOTH_L1_LOSS_BACKWARD_SHAPES = [
    (1024, 1024),
    (2048, 2048),
    (4096, 4096),
    (1024, 4096),
...
class SmoothL1LossBackwardBenchmark(GenericBenchmark):
    def set_shapes(self, shape_file_path=None):
        self.shapes = SMOOTH_L1_LOSS_BACKWARD_SHAPES
...
def smooth_l1_loss_backward_input_fn(shape, dtype, device):
    ...
    reduction = 0  # none
    beta = 1.0
    yield grad_output, self_t, target, reduction, beta
