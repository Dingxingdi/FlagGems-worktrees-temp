...
# Matrix pseudoinverse benchmark
def pinv_input_fn(shape, dtype, device):
    yield {"input": torch.randn(*shape, device=device, dtype=dtype)},


class PinvBenchmark(GenericBenchmark2DOnly):
    def set_more_shapes(self):
        # Use square and rectangular matrix shapes for pinv
        return [(16, 16), (32, 32), (64, 64), (128, 128), (16, 32), (32, 16)]


@pytest.mark.linalg_pinv
def test_perf_linalg_pinv():
    bench = PinvBenchmark(
        input_fn=pinv_input_fn,
        op_name="linalg_pinv",
