...
# Efficient attention backward benchmark
ATTENTION_BACKWARD_SHAPES = [
...
class ScaledDotProductEfficientAttentionBackwardBenchmark(Benchmark):
    def set_shapes(self, shape_file_path=None):
        self.shapes = ATTENTION_BACKWARD_SHAPES
...
def test_perf_scaled_dot_product_efficient_attention_backward():
    bench = ScaledDotProductEfficientAttentionBackwardBenchmark(
        ...
        torch_op=torch.ops.aten._scaled_dot_product_efficient_attention_backward,
