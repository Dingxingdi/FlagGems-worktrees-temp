...
# Quantized GRU benchmark
# Note: Due to the benchmark framework's shape loading from YAML files,
# and the unique 3D shape requirements of GRU (batch, seq, input_size),
# a full benchmark would require adding quantized_gru to core_shapes.yaml.
# For now, we provide a simple placeholder benchmark.

# @pytest.mark.quantized_gru
# def test_perf_quantized_gru():
#     pass  # Placeholder - requires YAML configuration
