...
def log_sigmoid_backward_input_fn(shape, dtype, device):
...
class LogSigmoidBackwardBenchmark(GenericBenchmark):
    def set_more_shapes(self):
        return None


@pytest.mark.log_sigmoid_backward
def test_perf_log_sigmoid_backward():
    bench = LogSigmoidBackwardBenchmark(
        input_fn=log_sigmoid_backward_input_fn,
