...
class FftRfftfreqBenchmark(Benchmark):
    def set_shapes(self, shape_file_path=None):
        self.shapes = RFFTFREQ_SHAPES
...
def test_perf_fft_rfftfreq():
    bench = FftRfftfreqBenchmark(
        op_name="fft_rfftfreq",
        torch_op=torch.fft.rfftfreq,
        dtypes=FLOAT_DTYPES,
    )
    bench.run()
