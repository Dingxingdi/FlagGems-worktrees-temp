...
class LinalgEigvalsBenchmark(Benchmark):
    def set_shapes(self, shape_file_path=None):
        # Only 2x2 matrices are supported with Triton kernel
        self.shapes = [(2, 2)]
...
def test_perf_linalg_eigvals():
    bench = LinalgEigvalsBenchmark(
        op_name="linalg_eigvals",
        torch_op=torch.ops.aten.linalg_eigvals,
