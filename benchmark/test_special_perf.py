...
# embedingBagCollection benchmark
...
class EmbeddingBagCollectionBenchmark(Benchmark):
    def set_shapes(self, shape_file_path=None):
    ...
    def get_input_iter(self, cur_dtype):
        for shape in self.shapes:
            ...
            indices = torch.randint(0, num_embeddings, (num_indices,), device=self.device)
            # Create offsets
