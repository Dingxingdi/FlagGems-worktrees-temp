...
# Feature dropout benchmark - requires 2D+ input
...
class FeatureDropoutBenchmark(Benchmark):
    def set_shapes(self, shape_file_path=None):
        self.shapes = FEATURE_DROPOUT_SHAPES
...
def test_perf_feature_dropout():
    bench = FeatureDropoutBenchmark(
        ...
        torch_op=torch.ops.aten.feature_dropout,
        dtypes=FLOAT_DTYPES,
    )
    bench.run()
