...
def convert_weight_to_int4pack_input_fn(shape, dtype, device):
    """Input function for _convert_weight_to_int4pack benchmark."""
...
def test_perf_convert_weight_to_int4pack():
    # Use valid weight matrix shapes where N is divisible by 32 (for innerKTiles=2)
    shapes = [(16, 64), (16, 128), (16, 256), (32, 128), (32, 256), (64, 256)]
    dtypes = [torch.uint8]

    bench = GenericBenchmark2DOnly(
        input_fn=convert_weight_to_int4pack_input_fn,
