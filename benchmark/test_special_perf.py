...
# Matmul_Layer_Norm benchmark
class MatmulLayerNormBenchmark(GenericBenchmark2DOnly):
    """
...
def matmul_layernorm_torch_op(input, weight, bias):
    ...
    return torch.nn.functional.layer_norm(matmul_result, [matmul_result.shape[-1]], eps=1e-5)


@pytest.mark.matmul_layernorm
def test_perf_matmul_layernorm():
