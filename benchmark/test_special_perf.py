...
# triu_indices benchmark
TRIU_INDICES_CONFIGS = [
    (3, 3, 0),
    (10, 10, 0),
    (100, 100, 0),
    (1000, 1000, 0),
...
class TriuIndicesBenchmark(Benchmark):
    def set_shapes(self, shape_file_path=None):
        self.shapes = TRIU_INDICES_CONFIGS

    def get_input_iter(self, cur_dtype):
        for row, col, offset in self.shapes:
            yield row, col, offset


@pytest.mark.triu_indices
def test_perf_triu_indices():
    bench = TriuIndicesBenchmark(
