...
# sym_constrain_range takes a scalar and returns None
# It's a no-op for compiler hints, so we benchmark with simple scalar inputs
...
@pytest.mark.performance
def test_perf_sym_constrain_range():
