...
class ScaledDotProductFlashAttentionBackwardBenchmark(Benchmark):
    def set_shapes(self, shape_file_path=None):
        self.shapes = FLASH_ATTENTION_BWD_SHAPES
...
def test_perf_scaled_dot_product_flash_attention_backward():
    bench = ScaledDotProductFlashAttentionBackwardBenchmark(
        op_name="_scaled_dot_product_flash_attention_backward",
        torch_op=torch.ops.aten._scaled_dot_product_flash_attention_backward,
