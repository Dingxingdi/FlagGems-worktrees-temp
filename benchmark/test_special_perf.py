...
class CsltSparseMmBenchmark(Benchmark):
    ...
    def set_shapes(self, shape_file_path=None):
        # Test with square matrices of various sizes
        self.shapes = [(64, 64), (128, 128), (256, 256), (512, 512)]
...
def test_perf_cslt_sparse_mm():
    bench = CsltSparseMmBenchmark(
        op_name="_cslt_sparse_mm",
        torch_op=flag_gems.ops._cslt_sparse_mm,
