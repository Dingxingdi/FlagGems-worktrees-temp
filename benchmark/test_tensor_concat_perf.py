...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            ...
            split_with_sizes_input_fn,
            FLOAT_DTYPES,
            marks=pytest.mark.unsafe_split_with_sizes,
        ),
    ],
)
