...
forward_operations = [
    ...
    # Only test float32 since PyTorch doesn't support float16/bfloat16 for this op
    ("special_scaled_modified_bessel_k0", torch.special.scaled_modified_bessel_k0, [torch.float32]),
