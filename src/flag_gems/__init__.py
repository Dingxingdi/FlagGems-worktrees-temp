...
_FULL_CONFIG = (
    ...
    ("__ior__", ops.__ior__),
    ("__ior__.Scalar", ops.__ior__scalar),
    ("__ior__.Scalar_Tensor", ops.__ior__scalar_tensor),
    ("__ior__.Tensor", ops.__ior__),
    ("__ior__.Scalar_", ops.__ior__scalar_),
    ("__ior__.Tensor_", ops.__ior__tensor_),
    ("bmm", bmm),
    ("bmm.out", bmm_out),
    ("cat", cat),
    ("celu", celu),
