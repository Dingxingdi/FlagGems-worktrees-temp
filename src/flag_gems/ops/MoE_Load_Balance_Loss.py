...
def moe_load_balance_loss(gate_logits: torch.Tensor) -> torch.Tensor:
    """
    ...
    """
    logger.debug("GEMS MoE Load Balance Loss")
    ...
    expert_loads = torch.zeros(num_experts, dtype=torch.float32, device=gate_logits.device)
