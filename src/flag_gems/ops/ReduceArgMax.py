...
@libentry()
@triton.jit
def reduce_argmax_kernel_2(mid_value, mid_index, out, mid_size, BLOCK_MID: tl.constexpr):
...
def ReduceArgMax(inp, dim=None, keepdim=False, *, dtype=None):
    ...
    if dim is None:
        ...
        with torch_device_fn.device(inp.device):
            ...
            reduce_argmax_kernel_2[(1, 1, 1)](mid_value, mid_index, out, mid_size, block_mid)
        return out
    else:
