...
def addmm_(self, mat1, mat2, *, beta=1, alpha=1):
    ...
    logger.debug(
        "GEMS ADDMM_, [shape info]: [-, %s, %s, %s](batch, M, N, K), "
        "[A column-major]: %s, [B column-major]: %s, [self column-major]: %s",
        M,
        N,
        K,
        mat1.stride(0) == 1,
    ...
    # self is both input (bias) and output (in-place)
    self = self.broadcast_to((M, N))
