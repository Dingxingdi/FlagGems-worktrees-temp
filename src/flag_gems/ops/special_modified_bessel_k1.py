...
def special_modified_bessel_k1_func(x):
    ...
    asymp_correction = 1.0 + 3.0 / 8.0 * x_inv - 15.0 / 128.0 * x_inv2 + 105.0 / 1024.0 * x_inv3
...
def special_modified_bessel_k1_(A):
    logger.debug("GEMS SPECIAL_MODIFIED_BESSEL_K1_")
    special_modified_bessel_k1_func(A, out0=A)
    return A