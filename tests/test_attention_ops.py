...
@pytest.mark.parametrize(
    ...
    [
        # Test cases for GQA (num_q_head > num_kv_head)
        (2, 4, 2, 512, 512, 64),
        (2, 4, 2, 512, 512, 128),
        (2, 4, 1, 1024, 1024, 64),
        (2, 4, 1, 1024, 1024, 128),
...
def test_grouped_query_attention_gqa(
    ...
    """Test Grouped_Query_Attention_GQA operator."""
    device = torch_device_fn.current_device()
    q, k, v = make_input(
    ...
    # Reference: use torch.nn.functional.scaled_dot_product_attention with enable_gqa=True
    ...
    # GEMS implementation
    with flag_gems.use_gems():
        gems_out = flag_gems.ops.Grouped_Query_Attention_GQA(
            q,
            k,
            v,
            attn_mask=None,
