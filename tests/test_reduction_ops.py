...
AVGPOOL3D_CONFIGS = [
    ...
    # Non-square kernel and stride
    ((2, 8, 8, 28, 28), (2, 3, 5), (1, 1, 2), 1, False, True, None),
    # Test ceil_mode (disabled - requires further investigation)
    # ((2, 4, 8, 15, 15), 3, 2, 1, True, True, None),
    # Test divisor_override
    ((1, 1, 4, 7, 7), 2, 1, 0, False, True, 1),
    # Larger case from a typical 3D CNN
    ((1, 64, 8, 56, 56), 3, 2, 1, False, True, None),
    # No padding, count_include_pad=False
    ((2, 8, 4, 16, 16), 2, 2, 0, False, False, None),
    # Non-square padding
    ((2, 8, 4, 16, 20), 2, 2, (1, 1, 0), False, True, None),
]
