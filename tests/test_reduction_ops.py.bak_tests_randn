...
# max_pool3d_with_indices test configs
MAXPOOL3D_CONFIGS = [
    # Basic case
    ((1, 1, 4, 4, 4), 2, 2, 0, 1, False),
    # With padding
    ((1, 1, 8, 8, 8), 3, 2, 1, 1, False),
    # Test ceil_mode
    ((2, 2, 7, 7, 7), 3, 2, 0, 1, True),
    # Test dilation
    ((1, 1, 7, 7, 7), 2, 1, 0, 2, False),
    # Larger case
    ((1, 16, 16, 16, 16), 3, 2, 1, 1, False),
    # No padding
    ((2, 4, 8, 8, 8), 2, 2, 0, 1, False),
    # Non-square kernel
    ((1, 1, 8, 8, 8), (1, 2, 2), (1, 2, 2), 0, 1, False),
    # Non-square stride
    ((1, 1, 8, 8, 8), 2, (1, 2, 2), 0, 1, False),
    # Non-square padding
    ((1, 1, 8, 8, 8), 2, 2, (1, 0, 0), 1, False),
]
