...
@pytest.mark.parametrize("dtype", FLOAT_DTYPES)
def test_accuracy__chunk_cat_1d(dtype):
    ...
    for shape in shapes:
        for num_chunks in num_chunks_list:
            ...
            ref_out = torch._chunk_cat([ref_inp], dim=0, num_chunks=num_chunks)
            with flag_gems.use_gems():
                res_out = torch._chunk_cat([inp], dim=0, num_chunks=num_chunks)
...
@pytest.mark.chunk_cat
@pytest.mark.parametrize("dtype", FLOAT_DTYPES)
def test_accuracy__chunk_cat_2d_dim0(dtype):
...
@pytest.mark.chunk_cat
@pytest.mark.parametrize("dtype", FLOAT_DTYPES)
def test_accuracy__chunk_cat_2d_dim1(dtype):
    ...
    for shape in shapes:
        for num_chunks in num_chunks_list:
            ...
            ref_out = torch._chunk_cat([ref_inp], dim=1, num_chunks=num_chunks)
            with flag_gems.use_gems():
                res_out = torch._chunk_cat([inp], dim=1, num_chunks=num_chunks)
...
@pytest.mark.chunk_cat
@pytest.mark.parametrize("dtype", FLOAT_DTYPES)
def test_accuracy__chunk_cat_multiple_tensors(dtype):
    ...
    ref_out = torch._chunk_cat([ref_inp1, ref_inp2], dim=0, num_chunks=num_chunks)
    with flag_gems.use_gems():
        res_out = torch._chunk_cat([inp1, inp2], dim=0, num_chunks=num_chunks)
