...
# GRU_Attention test - custom attention mechanism with GRU-style gating
...
def test_accuracy_gru_attention(shape):
    """Test for GRU_Attention operator with float32.
    ...
    # Run with FlagGems
    with flag_gems.use_gems():
        from flag_gems.ops.GRU_Attention import gru_attention
        res_out = gru_attention(query, key, value, scale=scale)
