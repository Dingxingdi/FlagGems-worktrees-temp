...
@pytest.mark.parametrize("min_val", [None, 0, 1])
@pytest.mark.parametrize("max_val", [None, 10, 100])
def test_accuracy_sym_constrain_range(min_val, max_val):
    # Test sym_constrain_range with scalar input
    # This is a compiler hint that returns None
    size = 5
...
@pytest.mark.parametrize("min_val", [None, 0, 1])
@pytest.mark.parametrize("max_val", [None, 10, 100])
def test_accuracy_sym_constrain_range_for_size(min_val, max_val):
    # Test sym_constrain_range_for_size with scalar input
    # This is a compiler hint that returns None
    size = 5
