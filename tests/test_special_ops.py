...
# _convert_weight_to_int4pack tests
...
@pytest.mark.parametrize("shape_kt", INT4PACK_SHAPES)
def test_accuracy_convert_weight_to_int4pack(shape_kt):
    ...
    res_out = torch._convert_weight_to_int4pack(x, innerKTiles=innerKTiles)
