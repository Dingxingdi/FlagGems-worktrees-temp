...
@pytest.mark.parametrize("dtype", FLOAT_DTYPES)
def test_accuracy_embedingBagCollection(
    ...
    ref_output, ref_offset2bag, ref_bag_size, ref_max_indices = (
    ...
    from flag_gems.ops.embedingBagCollection import embedingBagCollection

    res_output, res_offset2bag, res_bag_size, res_max_indices = embedingBagCollection(
        weight,
        indices,
        offsets,
    ...
    # The atol in gems_assert_close is too strict for float16/bfloat16
