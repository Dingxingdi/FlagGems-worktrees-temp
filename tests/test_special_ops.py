...
def test_accuracy_pin_memory(shape, dtype):
    ...
    # Reference output is just a copy of input (same data but different object)
    # This is what torch._pin_memory does - returns a copy on the same device
    ref_inp = to_reference(inp)
    ...
    gems_assert_close(res_out, ref_out, dtype)
    # Result should not be the same object
