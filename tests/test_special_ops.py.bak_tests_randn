...
@pytest.mark.parametrize("dtype", FLOAT_DTYPES)
def test_accuracy_tensor_split_by_int(shape, dtype):
...
@pytest.mark.parametrize("shape", TENSOR_SPLIT_SHAPES)
@pytest.mark.parametrize("dtype", FLOAT_DTYPES)
def test_accuracy_tensor_split_by_list(shape, dtype):
...
@pytest.mark.parametrize("shape", TENSOR_SPLIT_SHAPES)
@pytest.mark.parametrize("dtype", FLOAT_DTYPES)
def test_accuracy_tensor_split_dim(shape, dtype):
...
@pytest.mark.tensor_split
@pytest.mark.parametrize("dtype", FLOAT_DTYPES)
def test_accuracy_tensor_split_uneven(dtype):
