...
# Swin Transformer Attention tests
ATTENTION_SHAPES = [
    (1, 2, 16, 32),  # (B, H, S, D)
    (2, 4, 32, 64),
    (4, 8, 64, 128),
...
def test_accuracy_Swin_Transformer_Attention(shape, dtype):
    ...
    # Compute reference using scaled_dot_product_attention (as proxy for attention)
    scale = 1.0 / (D**0.5)
